...
/// <summary>Admin-only Event Log list for the UI. Disabled while EventLog:Enabled is false.</summary>
[ApiController]
...
public sealed class EventLogsController : ControllerBase
{
    ...
    public EventLogsController(
        ...
        IEventLogQueryService queryService,
    ...
    /// <summary>Paginated Event Log rows for the current tenant.</summary>
    [HttpGet]
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        var query = new ListEventLogsQuery(page, pageSize, category, severity, userEmail, dateFrom, dateTo, search);
