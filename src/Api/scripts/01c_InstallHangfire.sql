-- =============================================
-- HANGFIRE - Background Jobs Schema
-- Run against ezofis_catalog_Dev (Hangfire uses DefaultConnection = catalog)
-- Usage: sqlcmd -S localhost -d ezofis_catalog_Dev -E -i 01c_InstallHangfire.sql
-- =============================================
